window.OSavePresentation = {
  ...
  achievements: [
    { group: "Import- 08/07/2026-63.24%", title: "Import", subtitle: "VERTEX - Consolidated Accounting & Inventory", image: "assets/achievements/vos-erp-source.png", caption: "VERTEX (Import): Active in corporate subsidiaries. Handles over Php 250M of consolidated transactions annually. Projected annual profit is Php 15M." },
    { group: "Local-08/12/2026-58.33%", title: "Local", subtitle: "Hanvin - Solar grid deployment", image: "assets/achievements/lgu-mapandan-source.jpeg", caption: "Local: Completed high-capacity solar grid installation project, serving as the model site for group green energy integration." },
    { group: "Local- 08/25/2026-58.67%", title: "Local", subtitle: "MEN2 Dagupan", image: "assets/achievements/foodsphere-source.jpg", caption: "Local: Successfully engaged with Foodsphere Inc. (Frozen) in La Union, securing storage and distribution operations." },
